...
class Repository extends Component {
    constructor(props) {
        ...
        if (typeof window !== 'undefined') {
            ...
            let split = id.split('/');
            fetch('https://minestom.net/api/v2/repository?id=' + id)
                                    ...
                                    fetch(BASE_URL + '/.github' + README)
                                        ...
                                        .catch((err2) => {
                                            ...
                                            ReactDOM.render(
                                                <Error
                                                    text={
                                                        "This extension doesn't have a README.md or we couldn't access it."
                                                    }
                                                />,
                                                this.readme.current
                                            );
